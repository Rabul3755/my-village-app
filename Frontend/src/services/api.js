  ...
  (config) => {
    if (config.url && config.url.includes("undefined")) {
      return Promise.reject(
        new Error("Invalid request: Missing required parameters"),
      );
    }
...
export const adminAPI = {
  ...
  getAdminIssues: (filters = {}) =>
    api.get("/admin/issues", { params: filters }),
  ...
  getAdminLeaders: (filters = {}) =>
    api.get("/admin/leaders", { params: filters }),
  ...
  bulkDeleteLeaders: (data) =>
    api.delete("/admin/leaders/bulk-delete", { data }),
  ...
  updateRepresentative: (id, data) =>
    api.put(`/admin/representatives/${id}`, data),
